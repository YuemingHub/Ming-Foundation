...
> Non-normative traceability map. KERNEL-0001 remains the proposed requirement
> source. Referenced RFCs and Profiles retain their own authority and status.

## 1. Crosswalk

| ID | Domain | Level | Proposed requirement | Sources | Integration type | Delegated/future detail |
|---|---|---|---|---|---|---|
...
- MF-0004 and PROJECT-MINGOS-0002 remain Candidate.
- Their Chinese paired texts remain Candidate translations under the current
...
- KERNEL-0000 and KERNEL-0001 remain Draft.

A requirement mapping does not promote a source.

## 3. Synchronization requirements

Any change to a KCR item must update:

- KERNEL-0001;
- this crosswalk;
- the machine-readable requirement index;
- affected ambiguity and vocabulary records;
- delegated RFC/Profile compatibility;
- changelog and migration record when normative meaning changes.

## 4. Gap summary

- high-impact threshold: unresolved;
- confidence semantics: unresolved;
- direct and representative participation minimums: unresolved;
- unavailable service and handoff completion: unresolved;
- organization-level applicability: unresolved;
- cross-language normative equality: unresolved;
- conformance requirement and test design: deferred to Round 09.
