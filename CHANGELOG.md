...
- Draft Kernel canonical object/data model and lifecycle/state machines (`KERNEL-0002`, `KERNEL-0003`) with object, transition, access, ambiguity, review, machine-index and validation artifacts (`REF-0035` through `REF-0039`).
